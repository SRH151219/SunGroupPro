					...
					<ul class="food-box">
						<li v-for="(item,index) in this.list"
							...
							<div class="right">
								...
								<p>￥<i class="price">{{item.price}}</i></p>
								<div class="btn">
									<i class="del"
...
.shopCar {
  ...
  h3 {
    ...
    text-align: center;
	.l_h(40);
	background: -webkit-linear-gradient(left, orange , #f14e16); /* Safari 5.1 - 6.0 */ background: -o-linear-gradient(right, orange, #f14e16); /* Opera 11.1 - 12.0 */ background: -moz-linear-gradient(right, orange, #f14e16); /* Firefox 3.6 - 15 */ background: linear-gradient(to right, orange , #f14e16); /* 标准的语法 */
  }
  .content,
  .content-empty {
    .w(375);
